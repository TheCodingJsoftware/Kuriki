export const mathematicsCurriculumSkills: Record<string, string[]> = {
    "Communication": [
    ...
    "Visualization": [
        ...
        "Visualization is fostered through the use of concrete materials, technology, and a variety of visual representations. It is through visualization that abstract concepts can be understood concretely by the student.",
        "Visualization is a foundation to the development of abstract understanding, confidence, and fluency."
    ]
};
